...
-module(.umberum.logger.mongodb.writer_sup).
...
%% --------------------------
start_client(Router) ->
    .supervisor:start_child(umberum.logger.mongodb.writer_sup, [Router]).
        ...
        {_SupFlags = {simple_one_for_one, ?MAX_RESTART, ?MAX_TIME},
            [
              ...
              {   undefined,                               % Id       = internal id
                  {.umberum.logger.mongodb.writer_fsm,start_link,[]},                  % StartFun = {M, F, A}
